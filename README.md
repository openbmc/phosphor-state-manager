...
`/usr/share/phosphor-chassis-availability/`. A default config will be installed
which has a single mapping to the present property. OpenBMC machines can
override this file in the bitbake layer.
