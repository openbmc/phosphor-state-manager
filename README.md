...
- [drive][7]: The drive represents an individual storage device (NVMe/SSD)
  that supports power control. It follows the same daemon-per-instance pattern
  as the host and chassis state managers but uses string instance names (e.g.
