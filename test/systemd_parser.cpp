...
TEST(TargetJsonParser, BasicGoodPath)
{
    ...
    filePaths.insert("/tmp/good_file1.json");
    filePaths.insert("/tmp/good_file2.json");
...
TEST(TargetJsonParser, InvalidErrorToMonitor)
{
    ...
    std::set<std::string> filePaths;
    filePaths.insert("/tmp/invalid_error_file.json");
...
TEST(TargetJsonParser, InvalidFileFormat)
{
    ...
    std::set<std::string> filePaths;
    filePaths.insert("/tmp/invalid_json_file.json");
