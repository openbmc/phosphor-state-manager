...
bool wasHostBooting(sdbusplus::bus::bus& bus)
{
    ...
    {
        error("Error reading BootProgress, error {ERR}, service {SERVICE}, "
              "path {PATH}",
              "ERR", e, "SERVICE", HOST_STATE_SVC, "PATH", HOST_STATE_PATH);
...
void createErrorLog(sdbusplus::bus::bus& bus)
{
    ...
    {
        error("sdbusplus D-Bus call exception, error {ERR}, objpath {OBJPATH}, "
              "interface {INTERFACE}",
              "ERR", e, "OBJPATH", LOGGING_PATH, "INTERFACE",
              LOGGING_CREATE_INTF);
    ...
    {
        error("D-bus call exception: {ERR}", "ERR", e);
        throw e;
    }
}
...
void moveToHostQuiesce(sdbusplus::bus::bus& bus)
{
    ...
    {
        error("sdbusplus call exception starting quiesce target: {ERR}", "ERR",
              e);
