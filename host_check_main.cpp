...
void sendHeartbeat(sdbusplus::bus::bus &bus)
{
    ...
    auto method = bus.new_method_call(host.c_str(),
                                      ...
                                      "Execute");
    method.append("xyz.openbmc_project.Control.Host.Command.Heartbeat");
...
int main(int argc, char *argv[])
{
    ...
    std::string signalMatch = {"type='signal',"};
    signalMatch += "member='CommandComplete',";
    signalMatch += "path='";
    signalMatch += CONTROL_HOST_PATH;
    signalMatch += "',";
    signalMatch += "interface='";
    signalMatch += CONTROL_HOST_INTERFACE;
    signalMatch += "'";
