...
class Host : public HostInherit
{
  ...
  private:
    ...
    void save(Archive& archive, const std::uint32_t version) const
    {
        ...
        (void)(version);
        archive(
            convertForMessage(sdbusplus::xyz::openbmc_project::State::server::
                                  Host::requestedHostTransition()),
            convertForMessage(sdbusplus::xyz::openbmc_project::State::Boot::
                                  server::Progress::bootProgress()),
            convertForMessage(sdbusplus::xyz::openbmc_project::Control::Boot::
                                  server::RebootAttempts::attemptsLeft()),
            convertForMessage(sdbusplus::xyz::openbmc_project::Control::Boot::
    ...
    void load(Archive& archive, const std::uint32_t version)
    {
        ...
        archive(reqTranState, bootProgress, retryAttempts, attemptsLeft,
                osState);
