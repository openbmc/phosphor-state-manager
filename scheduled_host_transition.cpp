...
constexpr auto PURPOSE_PROPERTY = "RequestedHostTransition";
...
void ScheduledHostTransition::hostTransition()
{
    ...
    auto reqTrans = convertForMessage(HostTransition::requestedTransition());

    setProperty(bus, hostPath, HOST_BUSNAME, PURPOSE_PROPERTY, reqTrans);
