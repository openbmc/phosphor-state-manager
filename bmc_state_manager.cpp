...
std::string BMC::getBootDevice() const
{
    char bootDevice = 0;
    std::ifstream file;
    ...
    // The 0 or 1 value read from the file indicates which flash the system booted from. 
    // If the value is not 0 or 1, then it is unknown which device was used to boot
    switch(bootDevice)
    {
        case '0':
