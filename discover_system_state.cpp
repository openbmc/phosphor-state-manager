...
auto getBusName(sdbusplus::bus::bus& bus, std::string PATH,
    std::string INTERFACE)
{
    ...
    return mapperResponse.begin()->first.c_str();
}
...
int main()
{
    ...
    auto name = getBusName(bus, HOST_PATH, HOST_INTERFACE);

    //auto pgood = getProperty(bus, POWER_PATH, POWER_INTERFACE, "pgood");

    std::cout << pgood << std::endl;
