...
class ScheduledHostTransition : public ScheduledHostTransitionInherit
{
  ...
  private:
    ...
    /**
     * @brief covert requested transition from enum to string
     *
     * @param[in] trans - The requested transition
     * @return - A string corresponds to the requested transition
     **/
    std::string convertRequestedTransition(Transition trans);
